		...
		<tr>
						...
						<table border='0' cellpadding='0' cellspacing='0' style='width:100%'>
							<tbody>
								<tr>
									...
									<p name='text_box' style='color:#fff; font-family:Helvetica,sans-serif; font-size:24px; font-weight:bold; margin-bottom:0; margin-left:0; margin-right:0; margin-top:0; word-break:break-all'><?=$today?> 오늘의 뉴쓰</p>
									</td>
								</tr>
							</tbody>
						</table>
			...
			<table border='0' cellpadding='0' cellspacing='0' style='display:block; padding-top:5px; width:100%'>
				<tbody>
					<tr>
                      ...
                      <img alt='' border='0' name='upd_img' src='https://setoworks.cafe24.com/img/nsletter/mogyoil.jpg' style='display:inline-block; max-width:100%; vertical-align:middle' width='800' /> 
                  </td>
								</tr>
								<tr>
			...
			<table border='0' cellpadding='0' cellspacing='0' style='-moz-box-sizing:border-box; -webkit-box-sizing:border-box; box-sizing:border-box; display:block; padding-bottom:10px; padding-left:15px; padding-right:15px; padding-top:15px; width:100%'>
				<tbody>
                    ...
                    <img alt='' border='0' name='upd_img' src='https://setoworks.cafe24.com/img/nsletter/joomal.jpg' style='display:inline-block; max-width:100%; vertical-align:middle' width='385' />
                  </td>
